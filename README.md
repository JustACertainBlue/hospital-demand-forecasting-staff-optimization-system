...
- `[docs]([url](https://github.com/JustACertainBlue/hospital-demand-forecasting-staff-optimization-system/tree/main/docs))/` – report, slides, screenshots, system architecture
